...
import { faChevronLeft, faClock, faChevronRight } from '@fortawesome/free-solid-svg-icons'
...
export default function Home({ data, products, navbar }) {
            ...
            <div className="container-fluid h-100 py-5 absolute">
              <div className="row align-items-center h-100">
                <div className="col-lg-8 col-xl-6 mx-auto text-white text-center">
                  <h2 className="mb-4 display-5 text-uppercase font-weight-bold">{edge.fields.name}</h2>
                  <p className="lead mb-4">{edge.fields.shortDescription}</p>
                  <a className="btn btn-light" href={'/category/' + edge.fields.slug}>Read More</a>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="card">
      ...
      <div className="py-2">
        ...
        <span className="text-muted">EUR {node.fields.discountedPrice}</span>
      </div>
    </div>
  )
}
